...
REQUIRED = [
    "src/prediction_engine/strategy/__init__.py",
    "src/prediction_engine/strategy/second_leg_fsm.py",
    "scripts/run_second_leg_fsm.py",
    "scripts/validate_second_leg_fsm_package.py",
    "README_PACKAGE_18.md",
]
