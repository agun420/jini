...
def main() -> None:
    ...
    validate_python(Path("src/prediction_engine/trade_gate/paper_execution_gate.py"))
    validate_python(Path("scripts/run_paper_execution_gate.py"))

    print(
        json.dumps(
            {
                "status": "PASS",
                "message": "Package 7 validation passed.",
